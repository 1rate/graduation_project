...
export const SummaryStatsLine = ({ data }: SummaryStatsLineProps) => {
  const { total, posPct, negPct, negDelta, prevLabel, topCategory, topCategoryCount } = data;
  ...
  return (
    <Card>
      <CardContent className="p-4 text-sm leading-relaxed">
        ...
        <span> по сравнению с {prevLabel.toLowerCase()}. Основная проблема — </span>
